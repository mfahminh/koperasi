...
<div class="form-group">
    ...
    <select name="kode_jenis_pinjam" class="form-control">
                ...
                ?>
					<option value="<?php echo $a['kode_jenis_pinjam'];?>"><?php echo $a['nama_pinjaman'];?> /Maks : <?php echo $a['maks_pinjam'];?> /Admin : <?php echo $a['bunga'];?> /Lama : <?php echo $a['lama_angsuran'];?> Bulan</option>
				<?php
                }
                ?>
            </select>
