...
?>
    	...
    	<tr>
            ...
            <?php $d=$data['kode_anggota'];$f=mysql_fetch_array(mysql_query("SELECT nama_anggota from t_anggota where Kode_anggota='$d'")); $rty=mysql_fetch_array(mysql_query("SELECT sum(besar_simpanan) as total_asli from t_simpan where Kode_anggota='$d'")); $inves=$data['besar_tabungan']-$rty['total_asli'];?>
