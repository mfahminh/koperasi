...
{ $kode=$_GET['kode_anggota']; $anggota=mysql_fetch_array(mysql_query("SELECT nama_anggota from t_anggota where kode_anggota='$kode'")); ?>
  ...
  <div class="col-lg-12">
     <div class="form-panel">
        ...
        {
        	echo '<a href="href=index.php?pilih=2.1&aksi=operator" disabled="disabled" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Pengajuan Pinjaman</a> ';
        } 
        else if($df['status']=='lunas')
        {
        	echo '<a href=index.php?pilih=4.4&aksi=operator&kode_anggota='.$kode.' class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Pengajuan Pinjaman</a> ';
        } 
        else if($op<=0)
        {
        	echo '<a href=index.php?pilih=4.4&aksi=operator&kode_anggota='.$kode.' class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Pengajuan Pinjaman</a> ';
...
{ 
 ...
 elseif ($verida['nama_simpanan']=='Pokok') {
	echo '<a class="btn btn-warning" href="index.php?pilih=2.1&aksi=simpan&kode_anggota='.$kode.'&kode_jenis_simpan='.$verida['kode_jenis_simpan'].'"><i class="fa fa-list"></i> Pokok</a> ';
 }
 $no++;
}
?>
