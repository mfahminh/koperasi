...
$pros=$_GET['pros'];
	...
	switch($pros){
		case "simpan"	:
							$qtambah=mysql_query("INSERT INTO t_simpan VALUES('','$jenis_simpan','$besar_simpanan','$kode_anggota','$user_entri','$banding','$tgl_entri')");
		...
		case "angsur"	:	$sql=mysql_fetch_array(mysql_query("SELECT sisa_angsuran from 									t_pinjam where kode_pinjam='$kode_pinjam'"));
							...
							{
								mysql_query("UPDATE t_pinjam set sisa_angsuran='$angsuran_ke',sisa_pinjaman='$siso',status='lunas' where kode_pinjam='$kode_pinjam'");
							}
							else
							{
